...
class MotionVarModule : Module("_var_", ModuleCategory.Motion, defaultEnabled = true, private = true) {
    companion object {
        val LastUpdateAbilitiesPacket: MutableState<UpdateAbilitiesPacket?> = mutableStateOf(null)
    }
    override fun beforePacketBound(interceptablePacket: InterceptablePacket) {
         if (interceptablePacket.packet is UpdateAbilitiesPacket) {
             LastUpdateAbilitiesPacket.value = interceptablePacket.packet
         }
    }
}